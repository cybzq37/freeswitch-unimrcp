...
APRUTIL_EXPORT_INCLUDES="-I/usr/local/src/unimrcp-deps-1.5.0/libs/apr-util/xml/expat/lib"
APRUTIL_EXPORT_LIBS="/usr/local/src/unimrcp-deps-1.5.0/libs/apr-util/xml/expat/libexpat.la"
APRUTIL_LDFLAGS=""
